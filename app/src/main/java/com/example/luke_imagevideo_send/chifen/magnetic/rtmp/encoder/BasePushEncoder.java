...
import com.example.luke_imagevideo_send.chifen.magnetic.egl.EglHelper;
import com.example.luke_imagevideo_send.chifen.magnetic.egl.EglSurfaceView;
import com.example.luke_imagevideo_send.chifen.magnetic.util.ByteUtil;
...
//            }
            ...
            if (isScreen){
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                    final VirtualDisplay display = mediaProjection.createVirtualDisplay("screen-mirror", width, height, DisplayMetrics.DENSITY_MEDIUM, DisplayManager.VIRTUAL_DISPLAY_FLAG_PRESENTATION, mSurface, null, null);
                }
